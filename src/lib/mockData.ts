import { FraudulentApp, FraudulentUrl, FraudTrend, User } from '@/types/fraud';

export const mockFraudApps: FraudulentApp[] = [
  {
...
export const mockFraudUrls: FraudulentUrl[] = [
  {
...
export const mockFraudTrends: FraudTrend[] = [
...
export const mockUsers: User[] = [
  { email: 'admin@frauddashboard.com', password_hashed: '$2a$10$XYZ1234abcd$', role: 'Admin' },
  { email: 'analyst@frauddashboard.com', password_hashed: '$2a$10$ABC5678efgh$', role: 'Analyst' },
];